...
function exam_setup() {
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Header area', 'exam' ),
		) );
...
function exam_scripts() {
	...
	wp_enqueue_script( 'bootsrap', get_template_directory_uri() . '/libs/bootstrap-sass/assets/javascripts/bootstrap.min.js', array(), '20151215', true );
